...
class MockDataSource : BankDataSource {
    ...
    override fun patchBank(accountNumber: String, bank: Bank): Bank {
        val currentBank = banks.firstOrNull {it.accountNumber == accountNumber} ?: throw NoSuchElementException("Bank Not Found")
